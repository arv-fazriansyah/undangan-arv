...
const util = (() => {
    ...
    const tamu = () => {
        ...
        div.innerHTML = `<p class="mt-0 mb-0 mx-0 p-0 text-light">Kepada Yth Bapak/Ibu/Saudara/i</p><h1 class="text-light">${escapeHtml(name)}</h1><p class="mt-0 text-light">Tanpa Mengurangi Rasa Hormat, Kami Mengundang Anda Untuk Hadir Di Acara Pernikahan Kami.</p>`;
