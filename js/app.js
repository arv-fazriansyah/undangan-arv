...
const util = (() => {
    ...
    const tamu = () => {
        ...
        div.innerHTML = `<p class="mt-0 mb-3 mx-0 p-0 text-light">Kepada Yth,<br>Bapak/Ibu/Saudara/i</p><h1 class="text-light">${escapeHtml(name)}</h1><p class="mt-3 text-light">Tanpa Mengurangi Rasa Hormat,<br>Kami Mengundang Anda Untuk Hadir Di Acara Pernikahan Kami.</p>`;
